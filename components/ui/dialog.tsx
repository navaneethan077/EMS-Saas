    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          // Responsive width (THIS is the real upgrade)
          "max-w-[calc(100%-2rem)]",
          "sm:max-w-md",
          "md:max-w-lg",
          "lg:max-w-2xl",
          ...
          // Layout + spacing
          "gap-6 rounded-xl bg-popover p-6",

          // Scroll handling (important for real apps)
          ...
          // Styling
          "ring-1 ring-foreground/10 shadow-lg outline-none",
